...
import com.nurtaz.dev.weatherapp.App
import com.nurtaz.dev.weatherapp.BuildConfig
import com.nurtaz.dev.weatherapp.data.remote.identify.ApiIdentify
import com.nurtaz.dev.weatherapp.data.remote.ip.ApiIp
import com.nurtaz.dev.weatherapp.data.remote.plants.ApiPlants
import com.nurtaz.dev.weatherapp.data.remote.weather.ApiWeather
...
//        .addCallAdapterFactory(retrofitAuthAdapterFactory)
    ...
    @Singleton
    @Provides
    fun provideApiWeather(@Named(RETROFIT_WEATHER) retrofit: Retrofit): ApiWeather = retrofit.create(
        ApiWeather::class.java)
