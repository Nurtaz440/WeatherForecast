package com.nurtaz.dev.weatherapp.ui.pages.scan
...
import com.nurtaz.dev.weatherapp.data.remote.identify.IdentifyConstants
import com.nurtaz.dev.weatherapp.databinding.FragmentScanBinding
...
class ScanFragment : FragmentBase(true) {
    ...
    private lateinit var vBinding: FragmentScanBinding
    ...
    override fun onCreateView(
        ...
        vBinding =
            FragmentScanBinding.inflate(inflater, container, false).apply {
